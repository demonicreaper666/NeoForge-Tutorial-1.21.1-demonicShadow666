    ...
    private static final Map<Holder<ArmorMaterial>, List<MobEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<Holder<ArmorMaterial>, List<MobEffectInstance>>())
                    .put(ModArmorMaterials.BISMUTH,
                            List.of(
                                    new MobEffectInstance(MobEffects.JUMP, 400, 1, false, false),
                                    new MobEffectInstance(MobEffects.GLOWING, 400, 1, false, false),
                                    new MobEffectInstance(MobEffects.ABSORPTION, 400, 1, false,false)
                            )).build();
